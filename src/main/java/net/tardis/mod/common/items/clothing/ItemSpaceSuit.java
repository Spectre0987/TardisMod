...
public class ItemSpaceSuit extends ItemArmorBase {
	...
	public ItemSpaceSuit(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, String name) {
		super(material, renderIndexIn, equipmentSlotIn, name);
	}
