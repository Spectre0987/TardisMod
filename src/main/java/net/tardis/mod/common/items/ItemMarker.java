...
public class ItemMarker extends ItemBase {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (tag.hasKey(NBT.FIRST_POS))
			tooltip.add("First pos: " + Helper.formatBlockPos(BlockPos.fromLong(tag.getLong(NBT.FIRST_POS))));
		if (tag.hasKey(NBT.LAST_POS))
			tooltip.add("Last pos: " + Helper.formatBlockPos(BlockPos.fromLong(tag.getLong(NBT.LAST_POS))));
