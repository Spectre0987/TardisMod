...
public class RenderHelper {
	...
	public static void renderPortal(FakeWorldBoti fake, float partialTicks, float rotation, @Nullable Vec3d offset, @Nullable Vec3d size, boolean renderFog) {
		if (ClientProxy.getRenderBOTI() && MinecraftForgeClient.getRenderPass() == 1) {
			...
			//Handle Sky and fog
			if (!fake.provider.isSkyColored()) {
				GlStateManager.pushMatrix();
				Vec3d color = fake.provider.getFogColor(0, 0);
			...
			FakeWorldBoti.requestChunks(fake.dimensionID);
			RenderWorldShell.renderWorldShell(fake, new BlockPos(45, 45, 45), 40);
	...
	public static void renderPortal( FakeWorldBoti fake, float partialTicks, float rotation, @Nullable Vec3d offset, @Nullable Vec3d size) {
		RenderHelper.renderPortal(fake, partialTicks, rotation, offset, size, false);
	}
	
	public static void renderPortal( FakeWorldBoti fake, float partialTicks) {
		RenderHelper.renderPortal(fake, partialTicks, 0F, null, null, false);
	}
	
	public static void renderPortal( FakeWorldBoti fake, float partialTicks, float rot) {
		RenderHelper.renderPortal(fake, partialTicks, rot, null, null, false);
	}
	
	public static void renderPortal( FakeWorldBoti fake, float partialTicks, float rot, Vec3d offset) {
		RenderHelper.renderPortal(fake, partialTicks, rot, offset, null, false);
	}
