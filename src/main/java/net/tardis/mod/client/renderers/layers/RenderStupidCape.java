...
public class RenderStupidCape implements LayerRenderer<AbstractClientPlayer> {
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		if (!entitylivingbaseIn.getUniqueID().toString().equals("3f4f2acd-9427-4917-81c3-7b8a3031fffb") && !entitylivingbaseIn.getUniqueID().toString().equals("bc8b891e-5c25-4c9f-ae61-cdfb270f1cc1"))
			return;
