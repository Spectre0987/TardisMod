...
public class RenderTileDoor extends RenderExterior {
	...
	public static final Vec3d POSITION = new Vec3d(0, 0, 0);
	...
	public void renderPortal(TileEntityDoor te, float partialTicks) {
		...
		RenderHelper.renderPortal(renderShell, te, partialTicks, te.getDoorAngle(), RenderTileDoor.POSITION, null, false);
		GlStateManager.popMatrix();
	}
