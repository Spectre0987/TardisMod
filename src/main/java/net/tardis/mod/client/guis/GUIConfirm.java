...
public class GUIConfirm extends GuiScreen {
	...
	public void initGui() {
        ...
        this.listLines.addAll(this.fontRenderer.listFormattedStringToWidth(this.messageLine1, this.GUI_WIDTH - 20));
        this.listLines.addAll(this.fontRenderer.listFormattedStringToWidth(this.messageLine2, this.GUI_WIDTH - 20));
