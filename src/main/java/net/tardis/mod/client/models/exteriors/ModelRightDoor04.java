...
public class ModelRightDoor04 extends ModelBase {
	...
	public ModelRightDoor04() { 

		textureWidth = 256;
		textureHeight = 256;

		Shape1 = new ModelRenderer(this, 18, 72);
		Shape1.addBox(0.5F, -0.5F, -9.0F, 7, 1, 1);
		...
		Gen0.addBox(0.5F, 22.0F, -9.0F, 7, 1, 1);
		...
		Gen1.addBox(0.5F, 7.0F, -9.0F, 7, 1, 1);
		...
		Gen2.addBox(0.5F, 14.5F, -9.0F, 7, 1, 1);
		...
		Gen5.addBox(0.5F, -8.0F, -7.0F, 1, 31, 1);
		...
		Gen6.addBox(6.5F, -7.5F, -9.0F, 1, 30, 1);
		...
		Gen7.setRotationPoint(3.1F, -3.95F, -8.7F);
		...
		Gen8.setRotationPoint(4.9F, -3.95F, -8.7F);
		...
		Gen12.setRotationPoint(0.0F, -1.5F, -0.5F);
		...
		Gen13.setRotationPoint(0.0F, 5.0F, -9.8F);
		setRotation(Gen13, 1.2217304763960306F, 0.0F, 0.0F);
		Gen13.mirror = false;

		Gen14 = new ModelRenderer(this, 46, 81);
		Gen14.addBox(1.5F, -7.75F, -8.2F, 5, 8, 0);
