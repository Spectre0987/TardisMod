...
public class ModelRightDoor02 extends ModelBase {
	...
	public ModelRightDoor02() {
		...
		Shape1.addBox(0.5F, -0.5F, -8.5F, 7, 1, 1);
		...
		Gen0.addBox(0.5F, 22.0F, -8.5F, 7, 1, 1);
		...
		Gen1.addBox(0.5F, 7.0F, -8.5F, 7, 1, 1);
		...
		Gen2.addBox(0.5F, 14.5F, -8.5F, 7, 1, 1);
		...
		Gen5.addBox(0.5F, -7.0F, -6.5F, 1, 29, 1);
		Gen5.setTextureSize(256, 256);
		Gen5.setRotationPoint(0.0F, 0.0F, -2.0F);
		setRotation(Gen5, 0.0F, 0.0F, 0.0F);
		Gen5.mirror = false;

		Gen6 = new ModelRenderer(this, 13, 72);
		Gen6.addBox(6.5F, -7.0F, -8.5F, 1, 29, 1);
		...
		Gen7.setRotationPoint(3.1F, -4.0F, -7.7F);
		...
		Gen10.addBox(1.5F, -1.0F, -8.45F, 5, 1, 1);
		...
		Gen11.addBox(1.5F, -6.5F, -8.2F, 5, 29, 0);
