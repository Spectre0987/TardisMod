...
public class ModelTardis05 extends ModelBase implements IExteriorModel{
	...
	public ModelTardis05() { 
		...
		Shape1.addBox(9.85F, -11.5F, -8.0F, 1, 1, 16);
		...
		Gen0.addBox(6.5F, -8.0F, 8.0F, 1, 30, 1);
		...
		Gen5.addBox(-1.5F, -8.0F, 8.0F, 3, 30, 1);
		...
		Gen6.addBox(7.5F, -8.0F, -1.5F, 1, 30, 3);
		...
		Gen7.addBox(-7.5F, -0.5F, 8.0F, 15, 1, 1);
		...
		Gen8.addBox(-7.5F, 7.0F, 8.0F, 15, 1, 1);
		...
		Gen9.addBox(-7.5F, 14.5F, 8.0F, 15, 1, 1);
		...
		Gen10.addBox(-7.5F, 22.0F, 8.0F, 15, 1, 1);
		Gen10.setTextureSize(256, 256);
		Gen10.setRotationPoint(0.0F, 0.0F, 0.5F);
		setRotation(Gen10, 0.0F, 0.0F, 0.0F);
		Gen10.mirror = false;

		Gen11 = new ModelRenderer(this, 162, 81);
		Gen11.addBox(8.7F, 0.5F, -6.5F, 0, 22, 13);
		Gen11.setTextureSize(256, 256);
		Gen11.setRotationPoint(0.5F, 0.0F, 0.0F);
		...
		Gen12.setRotationPoint(8.7F, -3.75F, 4.9F);
		...
		Gen13.setRotationPoint(-4.9F, -3.75F, 8.7F);
		...
		Gen14.setRotationPoint(-3.1F, -3.75F, 8.7F);
		setRotation(Gen14, 0.0F, 0.7853981633974483F, 0.0F);
		Gen14.mirror = false;

		Gen15 = new ModelRenderer(this, 98, 0);
		Gen15.addBox(-8.5F, -12.0F, 8.75F, 17, 2, 2);
		Gen15.setTextureSize(256, 256);
		Gen15.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotation(Gen15, 0.0F, 0.0F, 0.0F);
		Gen15.mirror = false;

		Gen16 = new ModelRenderer(this, 98, 50);
		Gen16.addBox(-8.0F, -11.5F, -10.85F, 16, 1, 1);
		Gen16.setTextureSize(256, 256);
		Gen16.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotation(Gen16, 0.0F, 0.0F, 0.0F);
		Gen16.mirror = false;

		Gen17 = new ModelRenderer(this, 98, 50);
		Gen17.addBox(-8.0F, -11.5F, 9.85F, 16, 1, 1);
		Gen17.setTextureSize(256, 256);
		Gen17.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotation(Gen17, 0.0F, 0.0F, 0.0F);
		Gen17.mirror = false;

		Gen18 = new ModelRenderer(this, 119, 50);
		Gen18.addBox(-10.85F, -11.5F, -8.0F, 1, 1, 16);
		Gen18.setTextureSize(256, 256);
		Gen18.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotation(Gen18, 0.0F, 0.0F, 0.0F);
		Gen18.mirror = false;

		Gen19 = new ModelRenderer(this, 0, 134);
		Gen19.addBox(-7.5F, -8.0F, 8.0F, 15, 1, 1);
		Gen19.setTextureSize(256, 256);
		Gen19.setRotationPoint(0.0F, 0.0F, 0.5F);
		setRotation(Gen19, 0.0F, 0.0F, 0.0F);
		Gen19.mirror = false;

		Gen20 = new ModelRenderer(this, 129, 72);
		Gen20.addBox(7.5F, -0.5F, -7.5F, 1, 1, 15);
		...
		Gen21.addBox(7.5F, 7.0F, -7.5F, 1, 1, 15);
		Gen21.setTextureSize(256, 256);
		Gen21.setRotationPoint(1.0F, 0.0F, 0.0F);
		setRotation(Gen21, 0.0F, 0.0F, 0.0F);
		Gen21.mirror = false;

		Gen22 = new ModelRenderer(this, 129, 72);
		Gen22.addBox(7.5F, 14.5F, -7.5F, 1, 1, 15);
		Gen22.setTextureSize(256, 256);
		Gen22.setRotationPoint(1.0F, 0.0F, 0.0F);
		setRotation(Gen22, 0.0F, 0.0F, 0.0F);
		Gen22.mirror = false;

		Gen23 = new ModelRenderer(this, 129, 72);
		Gen23.addBox(7.5F, 22.0F, -7.5F, 1, 1, 15);
		Gen23.setTextureSize(256, 256);
		Gen23.setRotationPoint(1.0F, 0.0F, 0.0F);
		setRotation(Gen23, 0.0F, 0.0F, 0.0F);
		Gen23.mirror = false;

		Gen24 = new ModelRenderer(this, 13, 72);
		Gen24.addBox(-7.5F, -8.0F, 8.0F, 1, 30, 1);
		Gen24.setTextureSize(256, 256);
		Gen24.setRotationPoint(0.0F, 0.0F, 0.5F);
		setRotation(Gen24, 0.0F, 0.0F, 0.0F);
		Gen24.mirror = false;

		Gen25 = new ModelRenderer(this, 13, 72);
		Gen25.addBox(7.5F, -8.0F, 6.5F, 1, 30, 1);
		Gen25.setTextureSize(256, 256);
		Gen25.setRotationPoint(1.0F, 0.0F, 0.0F);
		setRotation(Gen25, 0.0F, 0.0F, 0.0F);
		Gen25.mirror = false;

		Gen26 = new ModelRenderer(this, 187, 0);
		Gen26.addBox(-0.5F, -8.0F, 8.2F, 1, 31, 1);
		Gen26.setTextureSize(256, 256);
		Gen26.setRotationPoint(0.0F, 0.0F, 0.5F);
		setRotation(Gen26, 0.0F, 0.0F, 0.0F);
		Gen26.mirror = false;

		Gen27 = new ModelRenderer(this, 129, 72);
		Gen27.addBox(7.5F, -8.0F, -7.5F, 1, 1, 15);
		Gen27.setTextureSize(256, 256);
		Gen27.setRotationPoint(1.0F, 0.0F, 0.0F);
		setRotation(Gen27, 0.0F, 0.0F, 0.0F);
		Gen27.mirror = false;

		Gen28 = new ModelRenderer(this, 13, 72);
		Gen28.addBox(7.5F, -8.0F, -7.5F, 1, 30, 1);
		Gen28.setTextureSize(256, 256);
		Gen28.setRotationPoint(1.0F, 0.0F, 0.0F);
		setRotation(Gen28, 0.0F, 0.0F, 0.0F);
		Gen28.mirror = false;

		Gen29 = new ModelRenderer(this, 0, 149);
		Gen29.addBox(-6.5F, 0.5F, 8.2F, 13, 22, 0);
		Gen29.setTextureSize(256, 256);
		Gen29.setRotationPoint(0.0F, 0.0F, 1.0F);
		setRotation(Gen29, 0.0F, 0.0F, 0.0F);
		Gen29.mirror = false;

		Gen30 = new ModelRenderer(this, 0, 137);
		Gen30.addBox(-6.5F, -0.5F, -0.5F, 13, 1, 1);
		Gen30.setTextureSize(256, 256);
		Gen30.setRotationPoint(0.0F, -3.75F, 8.7F);
		setRotation(Gen30, 0.7853981633974483F, 0.0F, 0.0F);
		Gen30.mirror = false;

		Gen31 = new ModelRenderer(this, 193, 0);
		Gen31.addBox(-0.5F, -0.5F, -6.5F, 1, 1, 13);
		Gen31.setTextureSize(256, 256);
		Gen31.setRotationPoint(8.7F, -3.75F, 0.0F);
		setRotation(Gen31, 0.0F, 0.0F, 0.7853981633974483F);
		Gen31.mirror = false;

		Gen32 = new ModelRenderer(this, 193, 0);
		Gen32.addBox(-0.5F, -3.5F, -0.5F, 1, 7, 1);
		Gen32.setTextureSize(256, 256);
		Gen32.setRotationPoint(8.7F, -3.75F, -4.9F);
		setRotation(Gen32, 0.0F, 0.7853981633974483F, 0.0F);
		Gen32.mirror = false;

		Gen33 = new ModelRenderer(this, 193, 0);
		Gen33.addBox(-0.5F, -3.5F, -0.5F, 1, 7, 1);
		Gen33.setTextureSize(256, 256);
		Gen33.setRotationPoint(8.7F, -3.75F, -3.1F);
		setRotation(Gen33, 0.0F, 0.7853981633974483F, 0.0F);
		Gen33.mirror = false;

		Gen34 = new ModelRenderer(this, 193, 0);
		Gen34.addBox(-0.5F, -3.5F, -0.5F, 1, 7, 1);
		Gen34.setTextureSize(256, 256);
		Gen34.setRotationPoint(8.7F, -3.75F, 3.1F);
		setRotation(Gen34, 0.0F, 0.7853981633974483F, 0.0F);
		Gen34.mirror = false;

		Gen35 = new ModelRenderer(this, 13, 72);
		Gen35.addBox(-9.0F, -8.0F, 6.5F, 1, 30, 1);
		Gen35.setTextureSize(256, 256);
		Gen35.setRotationPoint(-0.5F, 0.0F, 0.0F);
		setRotation(Gen35, 0.0F, 0.0F, 0.0F);
		Gen35.mirror = false;

		Gen36 = new ModelRenderer(this, 129, 72);
		Gen36.addBox(-9.0F, -8.0F, -7.5F, 1, 1, 15);
		Gen36.setTextureSize(256, 256);
		Gen36.setRotationPoint(-0.5F, 0.0F, 0.0F);
		setRotation(Gen36, 0.0F, 0.0F, 0.0F);
		Gen36.mirror = false;

		Gen37 = new ModelRenderer(this, 18, 75);
		Gen37.addBox(-9.0F, -8.0F, -1.5F, 1, 30, 3);
		Gen37.setTextureSize(256, 256);
		Gen37.setRotationPoint(-0.5F, 0.0F, 0.0F);
		setRotation(Gen37, 0.0F, 0.0F, 0.0F);
		Gen37.mirror = false;

		Gen38 = new ModelRenderer(this, 13, 72);
		Gen38.addBox(-9.0F, -8.0F, -7.5F, 1, 30, 1);
		...
		Gen39.addBox(-9.0F, 7.0F, -7.5F, 1, 1, 15);
		...
		Gen40.addBox(-9.0F, 14.5F, -7.5F, 1, 1, 15);
		...
		Gen41.addBox(-9.0F, 22.0F, -7.5F, 1, 1, 15);
		Gen41.setTextureSize(256, 256);
		Gen41.setRotationPoint(-0.5F, 0.0F, 0.0F);
		setRotation(Gen41, 0.0F, 0.0F, 0.0F);
		Gen41.mirror = false;

		Gen42 = new ModelRenderer(this, 187, 0);
		Gen42.addBox(-8.7F, -8.0F, -0.5F, 1, 31, 1);
		Gen42.setTextureSize(256, 256);
		Gen42.setRotationPoint(-1.0F, 0.0F, 0.0F);
		setRotation(Gen42, 0.0F, 0.0F, 0.0F);
		Gen42.mirror = false;

		Gen43 = new ModelRenderer(this, 162, 81);
		Gen43.addBox(-8.2F, 0.5F, -6.5F, 0, 22, 13);
		Gen43.setTextureSize(256, 256);
		Gen43.setRotationPoint(-1.0F, 0.0F, 0.0F);
		...
		Gen47.setRotationPoint(-8.7F, -3.75F, -3.1F);
		setRotation(Gen47, 0.0F, 0.7853981633974483F, 0.0F);
		Gen47.mirror = false;

		Gen48 = new ModelRenderer(this, 193, 0);
		Gen48.addBox(-0.5F, -3.5F, -0.5F, 1, 7, 1);
		Gen48.setTextureSize(256, 256);
		Gen48.setRotationPoint(-8.7F, -3.75F, -4.9F);
		setRotation(Gen48, 0.0F, 0.7853981633974483F, 0.0F);
		Gen48.mirror = false;

		Gen49 = new ModelRenderer(this, 46, 78);
		Gen49.addBox(-7.5F, -10.0F, 8.4F, 15, 1, 1);
		Gen49.setTextureSize(256, 256);
		Gen49.setRotationPoint(0.0F, 0.0F, 0.5F);
		setRotation(Gen49, 0.0F, 0.0F, 0.0F);
		Gen49.mirror = false;

		Gen50 = new ModelRenderer(this, 12, 33);
		Gen50.addBox(7.5F, -12.5F, 9.0F, 1, 36, 1);
		Gen50.setTextureSize(256, 256);
		Gen50.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotation(Gen50, 0.0F, 0.0F, 0.0F);
		Gen50.mirror = false;

		Gen51 = new ModelRenderer(this, 79, 106);
		Gen51.addBox(7.9F, -10.0F, -7.5F, 1, 1, 15);
		Gen51.setTextureSize(256, 256);
		Gen51.setRotationPoint(1.0F, 0.0F, 0.0F);
		setRotation(Gen51, 0.0F, 0.0F, 0.0F);
		Gen51.mirror = false;

		Gen52 = new ModelRenderer(this, 46, 75);
		Gen52.addBox(-7.5F, -9.5F, 8.3F, 15, 1, 1);
		Gen52.setTextureSize(256, 256);
		Gen52.setRotationPoint(0.0F, 0.0F, 0.5F);
		setRotation(Gen52, 0.0F, 0.0F, 0.0F);
		Gen52.mirror = false;

		Gen53 = new ModelRenderer(this, 46, 72);
		Gen53.addBox(-7.5F, -9.0F, 8.2F, 15, 1, 1);
		Gen53.setTextureSize(256, 256);
		Gen53.setRotationPoint(0.0F, 0.0F, 0.5F);
		setRotation(Gen53, 0.0F, 0.0F, 0.0F);
		Gen53.mirror = false;

		Gen54 = new ModelRenderer(this, 79, 72);
		Gen54.addBox(7.7F, -9.0F, -7.5F, 1, 1, 15);
		...
		Gen80.addBox(9.0F, -12.5F, 7.5F, 1, 36, 1);
		...
		Gen81.addBox(9.2F, -12.5F, 8.0F, 1, 36, 1);
		...
		Gen82.addBox(8.0F, -12.5F, 9.2F, 1, 36, 1);
		...
		Gen83.addBox(9.0F, -12.5F, -8.5F, 1, 36, 1);
		...
		Gen87.addBox(7.5F, -12.5F, -10.0F, 1, 36, 1);
		Gen87.setTextureSize(256, 256);
		Gen87.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotation(Gen87, 0.0F, 0.0F, 0.0F);
		Gen87.mirror = false;

		Gen88 = new ModelRenderer(this, 17, 33);
		Gen88.addBox(-9.5F, -12.5F, -9.5F, 19, 1, 19);
		...
		Gen89.addBox(9.2F, -12.5F, -9.0F, 1, 36, 1);
		...
		Gen90.addBox(9.2F, -12.5F, -9.5F, 1, 36, 1);
		Gen90.setTextureSize(256, 256);
		Gen90.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotation(Gen90, 0.0F, 0.0F, 0.0F);
		Gen90.mirror = false;

		Gen91 = new ModelRenderer(this, 12, 33);
		Gen91.addBox(9.0F, -12.5F, -10.0F, 1, 36, 1);
		...
		Gen92.addBox(8.0F, -12.5F, -10.2F, 1, 36, 1);
		...
		Gen98.addBox(-10.2F, -12.5F, 8.5F, 1, 36, 1);
		...
		Gen99.addBox(-10.2F, -12.5F, 8.0F, 1, 36, 1);
		...
		Gen100.addBox(-10.2F, -12.5F, -9.5F, 1, 36, 1);
	...
	ModelRightDoor05 rd = new ModelRightDoor05();
	ModelLeftDoor05 ld = new ModelLeftDoor05();
