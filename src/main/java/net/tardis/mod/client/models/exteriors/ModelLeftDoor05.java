...
public class ModelLeftDoor05 extends ModelBase {
	...
	ModelRenderer Gen13;
	ModelRenderer Gen14;
	ModelRenderer WindowGlow;

	public ModelLeftDoor05() { 

		textureWidth = 256;
		textureHeight = 256;

		Shape1 = new ModelRenderer(this, 187, 0);
		Shape1.addBox(-0.5F, -8.5F, -9.2F, 1, 31, 1);
		...
		Gen0.addBox(-7.5F, -8.5F, -9.0F, 7, 1, 1);
		...
		Gen2.addBox(-7.5F, 14.0F, -9.0F, 7, 1, 1);
		...
		Gen3.addBox(-7.5F, 21.5F, -9.0F, 7, 1, 1);
		...
		Gen4.setRotationPoint(-3.1F, -4.45F, -8.7F);
		...
		Gen5.setRotationPoint(-4.9F, -4.45F, -8.7F);
		...
		Gen8.addBox(-7.5F, -8.5F, -9.0F, 1, 31, 1);
		...
		Gen9.addBox(-7.5F, -1.0F, -9.0F, 7, 1, 1);
		...
		Gen10.addBox(-7.5F, 6.5F, -9.0F, 7, 1, 1);
		...
		Gen11.addBox(-6.5F, 6.0F, -8.3F, 5, 1, 1);
		...
		Gen12.addBox(-6.5F, -0.5F, -8.3F, 5, 1, 1);
		...
		Gen13.addBox(-7.0F, 0.0F, -8.3F, 1, 6, 1);
		...
		Gen14.addBox(-1.5F, -8.5F, -9.0F, 1, 31, 1);
		Gen14.setTextureSize(256, 256);
		Gen14.setRotationPoint(0.0F, 0.0F, -0.5F);
		setRotation(Gen14, 0.0F, 0.0F, 0.0F);
		Gen14.mirror = false;

		WindowGlow = new ModelRenderer(this, 0, 72);
		WindowGlow.addBox(-6.5F, -8.25F, -8.2F, 5, 8, 0);
		WindowGlow.setTextureSize(256, 256);
		WindowGlow.setRotationPoint(0.0F, 0.0F, -1.0F);
		setRotation(WindowGlow, 0.0F, 0.0F, 0.0F);
		WindowGlow.mirror = false;
