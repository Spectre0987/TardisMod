...
public class ModelInteriorDoorL03 extends ModelBase {
	//fields
	ModelRenderer LD1;
	ModelRenderer LD2;
	ModelRenderer LD3;
	...
	public ModelInteriorDoorL03() {
		...
		LD7.addBox(-6.5F, -6.5F, -8.7F, 5, 30, 0);
		LD7.setRotationPoint(0F, 0F, 0F);
		LD7.setTextureSize(128, 128);
		LD7.mirror = true;
		setRotation(LD7, 0F, 0F, 0F);
		LD8 = new ModelRenderer(this, 0, 0);
		LD8.addBox(-7.5F, 0.5F, -9F, 7, 1, 1);
		LD8.setRotationPoint(0F, 0F, 0F);
		LD8.setTextureSize(128, 128);
		LD8.mirror = true;
		setRotation(LD8, 0F, 0F, 0F);
		LD9 = new ModelRenderer(this, 0, 28);
		LD9.addBox(-2.5F, -0.5F, -0.5F, 5, 1, 1);
		LD9.setRotationPoint(-4F, -2.75F, -8.2F);
		LD9.setTextureSize(128, 128);
		LD9.mirror = true;
		setRotation(LD9, 0.7853982F, 0F, 0F);
		LD10 = new ModelRenderer(this, 0, 30);
		LD10.addBox(-0.5F, -3.5F, -0.5F, 1, 7, 1);
		LD10.setRotationPoint(-4.9F, -2.75F, -8.2F);
		LD10.setTextureSize(128, 128);
		LD10.mirror = true;
		setRotation(LD10, 0F, 0.7853982F, 0F);
		LD11 = new ModelRenderer(this, 0, 30);
		LD11.addBox(-0.5F, -3.5F, -0.5F, 1, 7, 1);
		LD11.setRotationPoint(-3.1F, -2.75F, -8.2F);
